...
## 深度学习部分Part_1（知识点阐述）<a name='top'> </a>
...
1. 单个感知机能模拟与/或/非门，但却不能表示异或运算。
   ...
   <img src="https://pic3.zhimg.com/80/v2-acca5a158cfb4e55124f6b2155a539be_720w.jpg" alt="img" style="zoom:65%; float:left" />
   ...
   <div align='center'>
       ...
       <img src="/home/lyp/桌面/机器学习大作业.assets/screenshot-www.cnblogs.com-2021.12.30-13_40_55.png" alt="image-20200802105033012" style="zoom:52%;" />
   </div>

2. 但将多个感知机组合起来，只关心输入和输出时，就可以表示异或运算

   <img src="https://gitee.com/cwkyaoyao/blog_img/raw/master/img/image-20200802123743467.png" alt="image-20200802123743467" style="zoom:55%; float:left" />

   

3. 对于任意的布尔函数，都可以变成真值表，然后针对每一项转化为DNF，最后通过MLP实现

   <img src="https://gitee.com/cwkyaoyao/blog_img/raw/master/img/image-20200802105132208.png" alt="image-20200802105132208" style="zoom:60%; float:left" />
